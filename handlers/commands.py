...
async def health_ecounter(message:Message):
    await message.answer(f"This is ur health {hp}")

@router.message(F.text == '⚡️⚡️⚡️')
async def stamina_encounter(message:Message):
    await message.answer(f"This is ur stamina {stamina}")

@router.message(F.text == 'Inventory')
async def show_inventory(message:Message):
    await message.answer(f'This is ur inventory {inventory}', reply_markup= await KB.drink_potion())
